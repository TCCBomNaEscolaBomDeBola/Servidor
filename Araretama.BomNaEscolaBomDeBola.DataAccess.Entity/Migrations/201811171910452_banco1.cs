    ...
    public partial class banco1 : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        TUR_IDADEMINIMA = c.Int(nullable: false),
                        TUR_IDADEMAXIMA = c.Int(nullable: false),
                        TUR_QUANTIDADE = c.Int(nullable: false),
                        TUR_HORARIOINICIAL = c.DateTime(nullable: false),
                        TUR_HOORARIOFINAL = c.DateTime(nullable: false),
                        TUR_DIASEMANA = c.String(nullable: false),
                    })
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.TB_ALUNO", t => t.Aluno_Id, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        AUL_DATACHAMADA = c.DateTime(nullable: false),
                        AUL_DATAENVIO = c.DateTime(nullable: false),
                        AUL_HORARIO = c.DateTime(nullable: false),
                        TUR_ID = c.Int(nullable: false),
                        Turma_Id = c.Int(),
                    })
